 ...
 * GET /api/recipe-scraper/recipes/{recipe_id}/pairing-suggestions
 *
 ...
 * @param params.count_only - If true, return only the total count instead of pairing data (default: false)
 */
