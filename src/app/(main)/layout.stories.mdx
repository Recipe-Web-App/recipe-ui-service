...
<Canvas>
  <Story name="Default">
    {() => (
      <MainLayout>
        <div className="p-6">
          <h1 className="text-2xl font-bold mb-4">Main Application Content</h1>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="p-6">
              <h3 className="font-semibold mb-2">Recipe Card</h3>
            ...
            <Card className="p-6">
              <h3 className="font-semibold mb-2">Meal Plan Card</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <Card className="p-6">
              ...
              <Button size="sm" variant="secondary">Create List</Button>
            </Card>
          </div>
        </div>
      </MainLayout>
