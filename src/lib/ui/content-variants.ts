  ...
  ],
  {
    variants: {
      variant: {
        ...
        network: ['bg-red-50', 'text-red-800', 'border', 'border-red-200'],
        '404': ['bg-gray-50', 'text-gray-600'],
        '500': ['bg-red-50', 'text-red-800'],
        unauthorized: ['bg-yellow-50', 'text-yellow-800'],
        validation: ['bg-orange-50', 'text-orange-800'],
