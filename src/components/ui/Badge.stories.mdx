...
<Canvas>
  <Story name="Cooking Times">
    <div className="flex flex-wrap gap-2">
      <Badge variant="secondary" size="sm">5 min</Badge>
      <Badge variant="secondary" size="sm">15 min</Badge>
      <Badge variant="secondary" size="sm">30 min</Badge>
      <Badge variant="secondary" size="sm">1 hour</Badge>
      <Badge variant="secondary" size="sm">2+ hours</Badge>
    </div>
  </Story>
</Canvas>
