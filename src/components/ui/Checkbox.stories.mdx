      ...
      return (
        <div className="space-y-4">
          <Checkbox
            ...
            onCheckedChange={checked =>
              setVariants(prev => ({ ...prev, default: checked }))
            }
          ...
          <Checkbox
            ...
            onCheckedChange={checked =>
              setVariants(prev => ({ ...prev, success: checked }))
            }
          ...
          <Checkbox
            ...
            onCheckedChange={checked =>
              setVariants(prev => ({ ...prev, warning: checked }))
            }
          ...
          <Checkbox
            ...
            onCheckedChange={checked =>
              setVariants(prev => ({ ...prev, danger: checked }))
            }
          ...
          <Checkbox
            ...
            onCheckedChange={checked =>
              setVariants(prev => ({ ...prev, info: checked }))
            }
            label="Info variant"
          />
          <Checkbox
            ...
            onCheckedChange={checked =>
              setVariants(prev => ({ ...prev, subtle: checked }))
            }
      ...
      return (
        <div className="space-y-4">
          <Checkbox
            ...
            onCheckedChange={checked =>
              setDietary(prev => ({ ...prev, vegetarian: checked }))
            }
            label="Vegetarian"
          ...
          <Checkbox
            ...
            onCheckedChange={checked =>
              setDietary(prev => ({ ...prev, vegan: checked }))
            }
            label="Vegan"
          ...
          <Checkbox
            ...
            onCheckedChange={checked =>
              setDietary(prev => ({ ...prev, glutenFree: checked }))
            }
            label="Gluten-free"
          ...
          <Checkbox
            ...
            onCheckedChange={checked =>
              setDietary(prev => ({ ...prev, dairyFree: checked }))
            }
            label="Dairy-free"
      ...
      return (
        <div className="space-y-4">
          <Checkbox
            ...
            onCheckedChange={checked =>
              setStates(prev => ({ ...prev, normal: checked }))
            }
      ...
      return (
        <div className="space-y-6">
          <CheckboxField
            ...
            required
            error={
              !form.terms ? 'You must accept the terms to continue' : undefined
            }
          />
          <CheckboxField
      ...
      return (
        <div className="space-y-4">
          <AnimatedCheckbox
            ...
            onCheckedChange={checked =>
              setAnimated(prev => ({ ...prev, scale: checked }))
            }
          ...
          <AnimatedCheckbox
            ...
            onCheckedChange={checked =>
              setAnimated(prev => ({ ...prev, bounce: checked }))
            }
          ...
          <AnimatedCheckbox
            ...
            onCheckedChange={checked =>
              setAnimated(prev => ({ ...prev, slide: checked }))
            }
      ...
      return (
        <div className="space-y-4">
          <Checkbox
            ...
            onCheckedChange={checked =>
              setA11y(prev => ({ ...prev, option1: checked }))
            }
          ...
          <Checkbox
            ...
            onCheckedChange={checked =>
              setA11y(prev => ({ ...prev, option2: checked }))
            }
          ...
          <Checkbox
            ...
            onCheckedChange={checked =>
              setA11y(prev => ({ ...prev, option3: checked }))
            }
            label="High contrast support"
            description="Works with high contrast mode and color preferences"
          />
          <div id="keyboard-help" className="mt-2 text-sm text-gray-600">
