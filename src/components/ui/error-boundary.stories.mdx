...
```jsx
const ErrorThrowingComponent = ({ shouldThrow = false, message = 'Demo error' }) => {
  if (shouldThrow) {
    throw new Error(message);
  }
  return <div className="p-4 bg-green-50 text-green-900 rounded">✅ Component working normally</div>;
};
```
      ...
      const FlakyComponent = () => {
        ...
        return (
          <div className="p-4 bg-green-50 text-green-900 rounded">
            ✅ Success! (After {errorCount - 1} retries)
          </div>
        );
      };
  ...
  <Story name="Reset Strategies">
    {() => {
      ...
      const ConditionalErrorComponent = () => {
        ...
        return (
          <div className="p-4 bg-green-50 text-green-900 rounded">
            ✅ Component recovered! Reset key: {resetKey}
          </div>
        );
      };
