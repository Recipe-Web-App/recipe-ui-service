...
<Meta
  ...
  parameters={{
    docs: {
      description: {
        component: 'A comprehensive table component system for displaying structured data in the recipe management application, with specialized variants for ingredients and nutrition information.',
      },
    },
  }}
/>
