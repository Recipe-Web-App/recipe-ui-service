      ...
      return (
        <div className="space-y-6">
          ...
          <Input
            ...
            value={values.filled}
            onChange={e =>
              setValues(prev => ({ ...prev, filled: e.target.value }))
            }
          ...
          <Input
            ...
            onChange={e =>
              setValues(prev => ({ ...prev, outlined: e.target.value }))
            }
      ...
      return (
        <div className="space-y-6">
          ...
          <Input
            ...
            value={sizes.default}
            onChange={e =>
              setSizes(prev => ({ ...prev, default: e.target.value }))
            }
      ...
      return (
        <div className="space-y-6">
          <Input
            ...
            onChange={e =>
              setStates(prev => ({ ...prev, default: e.target.value }))
            }
          ...
          <Input
            ...
            value={states.error}
            onChange={e =>
              setStates(prev => ({ ...prev, error: e.target.value }))
            }
          ...
          <Input
            ...
            onChange={e =>
              setStates(prev => ({ ...prev, success: e.target.value }))
            }
          ...
          <Input
            ...
            onChange={e =>
              setStates(prev => ({ ...prev, warning: e.target.value }))
            }
      ...
      return (
        <div className="space-y-6">
          <Input
            ...
            onChange={e =>
              setIconInputs(prev => ({ ...prev, search: e.target.value }))
            }
          ...
          <Input
            ...
            onChange={e =>
              setIconInputs(prev => ({ ...prev, email: e.target.value }))
            }
          ...
          <Input
            ...
            onChange={e =>
              setIconInputs(prev => ({ ...prev, location: e.target.value }))
            }
          ...
          <Input
            ...
            onChange={e =>
              setIconInputs(prev => ({ ...prev, phone: e.target.value }))
            }
      ...
      return (
        <div className="space-y-6">
          <Input
            value={floating.name}
            onChange={e =>
              setFloating(prev => ({ ...prev, name: e.target.value }))
            }
            placeholder=" "
            label="Full Name"
            floatingLabel
          ...
          <Input
            ...
            onChange={e =>
              setFloating(prev => ({ ...prev, email: e.target.value }))
            }
            placeholder=" "
            label="Email Address"
            floatingLabel
          ...
          <Input
            ...
            onChange={e =>
              setFloating(prev => ({ ...prev, message: e.target.value }))
            }
            placeholder=" "
            label="Message"
            floatingLabel
      ...
      return (
        <div className="space-y-6">
          <Input
            ...
            onChange={e =>
              setCountInputs(prev => ({ ...prev, title: e.target.value }))
            }
          ...
          <Input
            ...
            onChange={e =>
              setCountInputs(prev => ({ ...prev, description: e.target.value }))
            }
          ...
          <Input
            ...
            onChange={e =>
              setCountInputs(prev => ({ ...prev, tweet: e.target.value }))
            }
            ...
            errorText={
              countInputs.tweet.length > 280 ? 'Message is too long' : undefined
            }
          />
        </div>
      );
      ...
      return (
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <Input
            ...
            onChange={e =>
              setRecipe(prev => ({ ...prev, cookTime: e.target.value }))
            }
            placeholder="25"
          ...
          <Input
            ...
            onChange={e =>
              setRecipe(prev => ({ ...prev, temperature: e.target.value }))
            }
            placeholder="375"
