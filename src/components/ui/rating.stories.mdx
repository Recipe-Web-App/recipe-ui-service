...
<Meta
  ...
  parameters={{
    ...
    docs: {
      description: {
        component: 'A flexible rating component that supports stars, hearts, thumbs, and numeric displays with full accessibility support.'
      }
    }
  }}
/>
    ...
    <div className="p-4 border rounded-lg space-y-3">
      ...
      <div className="flex items-center gap-4">
        <Rating
          ...
          showLabel
        />
        <span className="text-sm text-muted-foreground">Excellent nutrition</span>
      </div>
    </div>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Disabled">
    <div className="space-y-4">
      ...
      <Rating value={2} interactive disabled showValue label="Disabled Interactive" showLabel />
    </div>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Read-only">
    <div className="space-y-4">
      ...
      <Rating value={3} interactive readOnly showValue label="Read-only Interactive" showLabel />
    </div>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Accessibility Demo">
    <div className="space-y-4">
      ...
      <p id="rating-help" className="text-xs text-muted-foreground">
