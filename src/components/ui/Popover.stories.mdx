...
<Meta
  ...
  parameters={{
    docs: {
      description: {
        component:
          'A floating content container that appears on demand, providing contextual information, actions, and forms in the recipe application.',
      },
    },
  }}
/>
            ...
            <SimplePopover
              content={
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    A tough cut that becomes tender when slow-cooked. Perfect
                    for stews.
                  </p>
            ...
            <SimplePopover
              content={
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    Adds depth of flavor to the stew. Use low-sodium for better
                    control.
                  </p>
                  <div className="space-y-1 text-sm">
                    <div className="font-medium">Substitutions:</div>
