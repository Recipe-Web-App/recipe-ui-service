  ...
  <Story name="Severity Levels">
    <div className="space-y-4">
      ...
      <ErrorAlert
        ...
        title="Warning"
      />
      <ErrorAlert error="For your information" severity="info" title="Info" />
    </div>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Without Icon">
    <ErrorAlert error="Error message without icon" showIcon={false} />
  </Story>
</Canvas>

<Canvas>
  <Story name="Without Close Button">
    <ErrorAlert error="Error message without close button" showClose={false} />
  </Story>
</Canvas>
