...
<Canvas>
  <Story name="With Label">
    {() => (
      <div className="space-y-4">
        <div className="text-muted-foreground text-sm">
          Showing user name alongside avatar:
        </div>
        <UserMenu showLabel />
      </div>
    )}
    ...
    {() => (
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <UserMenu className="border-primary rounded-full border" />
          <UserMenu showLabel className="bg-accent rounded-md px-3 py-1" />
        </div>
      </div>
    )}
  </Story>
