      ...
      <DefaultLayout>
        <div className="p-8">
          ...
          <p className="text-muted-foreground mb-6">
            This is the default layout with full navigation and footer.
            Perfect for main application pages.
          </p>
        ...
        <DefaultLayout>
          <div className="p-4">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              On mobile devices, the sidebar automatically converts to a drawer menu
              accessible via the hamburger button in the top navigation.
            </p>
            <div className="space-y-3">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="p-3 border rounded bg-card">
                  <h3 className="font-medium text-sm">Mobile Card {i + 1}</h3>
