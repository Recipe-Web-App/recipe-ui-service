      ...
      <DefaultLayout>
        <div className="p-8">
          ...
          <p className="text-muted-foreground mb-8">
            This is the default layout showcasing the full application experience
            with sidebar navigation, complete top navigation, and footer.
          </p>
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="p-6 border rounded-lg bg-card hover:shadow-md transition-shadow">
                ...
                <div className="flex gap-2">
                  ...
                  <span className="px-2 py-1 text-xs bg-secondary/10 text-secondary-foreground rounded">
                    30 min
                  </span>
                </div>
              </div>
